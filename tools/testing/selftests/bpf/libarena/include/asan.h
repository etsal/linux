 ...
 * compiler. The volatile attribute places the whole function
 * array in global data, preventing the compiler from generating
 * a rel.data section for patching the real function addresses
 * into the array.
 */
__attribute__((used))
